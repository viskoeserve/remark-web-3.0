...
export default defineNuxtConfig({
  app: {
    head: {
      ...
      //     name: "description",
      //     content:
      //       "Find jobs & talents using native AI tools. Find the best jobs & growth opportunities. Best Job Portal in India. Get personalized job recommendations for Free.",
      //   },
      //   {
      //     name: "keywords",
      //     content:
      //       "job portal,india job portal,job apply application,job portal sites in india,application regarding job",
      //   },
      // ],
      script: [
        {
