  ...
  <div class="bg-remark-light w-full flex justify-center h-full">
    <div>
      ...
      <VFlex
        ...
        class="flex-wrap md:flex-none gap-x-5 px-10 md:px-0"
      >
        <!-- LOGO & DETAILS -->
        <div class="w-full md:w-2/12 text-center md:text-left">
          ...
          <p class="text-slate-500">
           <NuxtLink to="/about" class="remark_tag">Remark</NuxtLink>, the best job portal in India, is a platform that brings
            Jobseekers and Employers together.
          </p>
          <VContainer class="my-3">
            ...
            <div class="flex gap-x-3 justify-center md:justify-start">
              <div>
                <a
                  href="https://facebook.com/remarkhr"
                  target="_blank"
              ...
              <div>
                <a
                  href="https://instagram.com/remarkhr"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <div>
                <a
                  href="https://www.linkedin.com/company/remark-official"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <div>
                <a
                  href="https://twitter.com/Remark_official"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <div>
                <a
                  href="https://www.youtube.com/@remark_official"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <Icon style="color: red;font-size:25px;" className="text-2xl"
                  name="mdi:youtube" />
                </a>
              </div>
            </div>
        ...
        <div class="w-full md:w-5/12">
          <div
            class="flex justify-center md:justify-between items-start flex-wrap md:flex-none text-center md:text-left gap-x-5"
          >
            <div class="w-50 md:w-4/12 my-6 md:my-0">
              <ul>
                ...
                <li class="my-2 font-semibold text-teal-900">
                  <a href="/how-it-works"> How Remark Works? </a>
                </li>
                <li class="my-2 font-semibold text-teal-900">
            ...
            <div class="w-50 md:w-3/12 my-6 md:my-0">
              <ul>
                ...
                <li class="my-2 font-semibold text-teal-900">
                  <a href="/support/technical"> Technical Support </a>
                </li>
                <li class="my-2 font-semibold text-teal-900">
                  <a href="/support/report-fraud"> Report Fraud </a>
                </li>
                <!-- <li class="my-2 font-semibold text-teal-900">
        ...
        <div
          class="w-full md:w-4/12 text-center border border-teal-800 p-4 rounded-lg"
        >
          <p class="font-bold text-2xl">
            <Icon name="ph:eyes-fill" /> Looking for job?
          </p>
          <VGap :height="5" />
          <p class="text-slate-500 text-sm">
            Let's connect and discuss your job requirements.
          </p>
          <VGap :height="5" />
          ...
          <VContainer :width="95" class="">
            <input
              v-model="instantForm.mobileNumber.value"
              type="text"
              class="border px-5 py-2 outline-none bg-remark-light"
              max="10"
          ...
          <VContainer class="text-center">
            <button
              v-if="!instantForm.isAdding"
              class="bg-teal-800 px-5 py-2 text-white rounded"
          ...
          <div class="text-center">
            <p class="text-teal-800 font-semibold text-sm">
              {{ instantForm.isSubmittedForm }}
            </p>
          </div>
        </div>
      </VFlex>
      ...
      <VContainer class="text-center text-sm text-slate-400">
        © 2024 Remark Developed by
        <a target="_blank" href="https://viskohr.com"
          >Visko HR Private Limited</a
        >
      </VContainer>
    </div>
  </div>
  ...
  methods: {
    async submitRequestForm() {
      ...
      if (this.instantForm.mobileNumber.value.length != 10) {
        ...
        this.instantForm.mobileNumber.errorMessage =
      ...
      if (data.value.status) {
        ...
        this.instantForm.isSubmittedForm =
          "Thank you, Remark team will contact you soon";
      }
