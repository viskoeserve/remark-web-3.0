<template>
  ...
  <div padding="50" class="bg-teal-0 w-full md:w-full px-5 md:px-40">
    ...
    <VFlex :justifyContent="'center'">
      ...
      <div class="w-full md:w-8/12">
        ...
        <div
          class="w-full flex justify-center mb-2 animate__animated animate__fadeIn"
        >
          <!-- <img class="w-4/12 md:w-3/12" src="/img/svg/remark-ai.png" /> -->
          <div class="w-11/12">
            <h1 class="font-bold text-2xl md:text-6xl text-center">
              Best <span class="text-teal-500">Job Portal</span> in India
              Unleashing Growth for Everyone
            </h1>
            <div class="my-2 md:my-5"></div>
            <div class="w-full flex justify-center text-center">
              <p
                class="w-10/12 text-slate-500 mt-2 text-center text-xs md:text-lg"
              >
                Remark Jobs is making the recruitment process easy and seamless.
                Now, Apply for Jobs, Hire Candidates, and Expand the Team easily
        ...
        <VFlex
          class="px-8 py-1 md:py-2 shadow-none border border-teal-300 rounded-full hover:shadow-xl hover:shadow-red-100 duration-200 hidden md:flex animate__animated animate__fadeIn"
        >
          <input
            v-model="searchInput"
            @keyup="searchJob"
            style="width: 100%"
            placeholder="Development, Back Office, Sales"
            class="py-3 bg-transparent outline-none border-none"
          />
          <VButton
            class="md:hidden"
            :to="
              searchInput == '' ? 'javascript:void(0)' : 'jobs?j=' + searchInput
            "
            fullBgColor="bg-red-600"
            :isLink="true"
            paddingY="3"
            rounded="full"
          >
        ...
        <div
          class="block md:hidden text-center animate__animated animate__fadeIn"
        >
          <div>
            <div
              class="bg-remark-light px-8 py-2 shadow-none border border-teal-300 rounded-full hover:shadow-xl hover:shadow-red-100 duration-200"
            >
              <input
                v-model="searchInput"
                @keyup="searchJob"
            ...
            <div class="flex w-full justify-center">
              <a
                class="block md:hidden bg-red-600 py-3 w-6/12 rounded-full"
                :href="
                  searchInput == ''
                    ? 'javascript:void(0)'
                    : 'jobs?j=' + searchInput
        ...
        <VContainer class="text-center animate__animated animate__fadeIn">
          ...
          <div class="pb-2 text-slate-400">Make your mark with remark!</div>
  ...
  <div
    class="w-[100%] mb-20 flex justify-center animate__animated animate__fadeInUp"
  >
    <div class="w-[95%] md:w-[80%]">
      <div class="w-full">
        ...
        <div class="flex flex-wrap justify-start md:gap-x-0">
          <div
            v-for="(category, i) in db.homepage.categories"
            :key="i"
            class="w-6/12 md:w-2/12 my-2 md:my-5 px-1 md:px-5"
          >
            <RCategory
              class=""
              :title="category.industry.industry_title"
              :slug="category.industry.industry_slug"
              :icon="category.industry.industry_logo"
      ...
      <div class="py-20">
        ...
        <div>
          <div class="flex flex-wrap justify-center">
            <div
              v-for="(company, i) in db.homepage.topCompanies"
              :key="i"
              class="w-full md:w-3/12 my-5 px-5"
            >
              <RTopCompanyCard
                ...
                :description="company.company_des"
              />
            </div>
          </div>
        </div>
    ...
    <div class="w-11/12 md:w-9/12 h-full">
      ...
      <div>
        <div class="flex flex-wrap justify-start">
          <div
            v-for="(job, i) in db.homepage.recentJobs"
            :key="i"
            class="w-full md:w-3/12 my-5 px-5"
          >
            <RQuickJobCard
              ...
              :minimum_salary="job.job_minimum_salary"
              :maximum_salary="job.job_maximum_salary"
              :company_state="job.company_state"
              :logo="job.company_logo"
              :slug="job.job_slug"
              :hiring="job.job_hiring_count"
  ...
  <VContainer
    :width="100"
    class="border bg-slate-900 rounded-lg h-full md:py-20 animate__animated animate__fadeIn"
  >
    <VFlex
      justifyContent="space-between"
      class="mx-auto w-8/12 flex-wrap md:flex-none"
    >
      <div
        class="text-white mt-20 mb-10 md:my-0 flex justify-center w-full md:w-20"
      >
        <VFlex class="gap-x-3">
          <div>
            <Icon
              class="text-6xl text-teal-200"
              name="tabler:briefcase-filled"
            />
          </div>
          <div>
      ...
      <div class="text-white mb-20 md:my-0 flex justify-center w-full md:w-20">
        <VFlex class="gap-x-3">
          <div>
            <Icon
              class="text-6xl text-teal-200"
              name="mdi:office-building-marker-outline"
            />
          </div>
          <div>
  ...
  <div
    class="w-full border flex justify-center bg-slate-900 h-full md:py-10 animate__animated animate__fadeIn"
  >
    <div
      class="w-full md:w-10/12 px-5 md:px-40 flex flex-wrap md:flex-nowrap justify-center text-center md:text-left"
    >
      <div class="w-6/12 md:w-3/12 text-white my-3 md:my-0">
        ...
        <div>
          <ul class="text-sm leading-6 text-slate-400">
            <li>
              <a target="_blank" href="/industries/industry-it-contractor"
                >IT Software Jobs</a
              >
            </li>
            <li>
            ...
            <li>
              <a target="_blank" href="/industries/industry-sales-marketing"
                >Sales Jobs</a
              >
            </li>
            <li>
      ...
      <div class="w-6/12 md:w-3/12 text-white my-3 md:my-0">
        ...
        <div>
          <ul class="text-sm leading-6 text-slate-400">
            ...
            <li>
              <a target="_blank" href="/jobs?j=opengl es jobs"
                >OpenGL ES Jobs</a
              >
            </li>
            <li>
            ...
            <li>
              <a target="_blank" href="/jobs?j=flash lite jobs"
                >Flash Lite Jobs</a
              >
            </li>
            <li>
            ...
            <li>
              <a target="_blank" href="/jobs?j=blackberry jobs"
                >Blackberry Jobs</a
              >
            </li>
            <li>
      ...
      <div class="w-6/12 md:w-3/12 text-white my-3 md:my-0">
        ...
        <div>
          <ul class="text-sm leading-6 text-slate-400">
            ...
            <li>
              <a target="_blank" href="/jobs?j=trade executive jobs"
                >Trade Executive Jobs</a
              >
            </li>
            <li>
            ...
            <li>
              <a target="_blank" href="/jobs?j=marketing jobs"
                >Marketing Jobs</a
              >
            </li>
            <li>
              <a target="_blank" href="/jobs?j=account executive jobs"
                >Accounts Executive Jobs</a
              >
            </li>
            <li>
              <a target="_blank" href="/jobs?j=management jobs"
                >Management Jobs</a
              >
            </li>
            <li>
              <a target="_blank" href="/jobs?j=water treatment jobs"
                >Water Treatment Jobs</a
              >
            </li>
            <li>
              <a target="_blank" href="/jobs?j=graphic designer jobs"
                >Graphic Designer Jobs</a
              >
            </li>
            <li>
            ...
            <li>
              <a target="_blank" href="/jobs?j=accountant jobs"
                >Taxation Jobs</a
              >
            </li>
          </ul>
      ...
      <div class="w-6/12 md:w-3/12 text-white my-3 md:my-0">
        ...
        <div>
          <ul class="text-sm leading-6 text-slate-400">
            <li>
              <a target="_blank" href="/jobs?j=jobs in delhi"
                >Jobs in New Delhi</a
              >
            </li>
            <li>
              <a target="_blank" href="/jobs?j=jobs in kolkata"
                >Jobs in Kolkata</a
              >
            </li>
            <li>
              <a target="_blank" href="/jobs?j=jobs in ahmedabad"
                >Jobs in Ahmedabad</a
              >
            </li>
            <li>
            ...
            <li>
              <a target="_blank" href="/jobs?j=jobs in gurgaon"
                >Jobs in Gurgaon</a
              >
            </li>
            <li>
              <a target="_blank" href="/jobs?j=jobs in mumbai"
                >Jobs in Mumbai</a
              >
            </li>
            <li>
              <a target="_blank" href="/jobs?j=jobs in chennai"
                >Jobs in Chennai</a
              >
            </li>
            <li>
              <a target="_blank" href="/jobs?j=jobs in hyderabad"
                >Jobs in Hyderabad</a
              >
            </li>
            <li>
              <a target="_blank" href="/jobs?j=jobs in banglore"
                >Jobs in Banglore</a
              >
            </li>
            <li>
            ...
            <li>
              <a target="_blank" href="/jobs?j=jobs in chandigarh"
                >Jobs in Chandigarh</a
              >
            </li>
            <li>
      ...
      <div class="w-full md:w-3/12 text-white my-3 md:my-0">
        ...
        <div>
          <ul class="text-sm leading-6 text-slate-400">
            ...
            <li>
              <a target="_blank" href="/jobs?j=account executive jobs"
                >Accountant Executive Jobs</a
              >
            </li>
            <li>
              <a target="_blank" href="/jobs?j=manager jobs"
                >Assistant Manager Jobs</a
              >
            </li>
            <li>
              <a target="_blank" href="/jobs?j=manager jobs"
                >Branch Manager Jobs</a
              >
            </li>
            <li>
              <a target="_blank" href="/jobs?j=cmo jobs"
                >Chief Marketing Officer Jobs</a
              >
            </li>
            <li>
              <a target="_blank" href="/jobs?j=ceo jobs"
                >Chief Executive Officer Jobs</a
              >
            </li>
            <li>
              <a target="_blank" href="/jobs?j=cto jobs"
                >Chief Technology Officer Jobs</a
              >
            </li>
            <li>
  ...
  <VModal
    @close="db.closeInstantJobForm"
    v-if="db.showInstantJobForm"
    v-auto-animate
  >
    <div class="w-full">
      ...
      <p class="text-slate-400 text-sm">
        ...
        <span class="text-red-500">Remark Support Team</span>
      </p>
      ...
      <div class="my-3">
        ...
        <div class="my-1"></div>
        <input
          v-model="instantJobForm.name.value"
          class="outline-none border px-5 w-full py-2 rounded-lg"
          placeholder="Your Name"
        />
        <small class="text-sm text-red-500" v-if="instantJobForm.name.isError">
          {{ instantJobForm.name.errorMessage }}
        </small>
      </div>
      <div class="my-3">
        ...
        <div class="my-1"></div>
        <input
          v-model="instantJobForm.mobileNumber.value"
          class="outline-none border px-5 w-full py-2 rounded-lg"
          type="tel"
          placeholder="+91"
        />
        <small
          ...
          v-if="instantJobForm.mobileNumber.isError"
        >
          {{ instantJobForm.mobileNumber.errorMessage }}
        </small>
      </div>
      <div class="my-3 text-center">
        <button
          v-if="!instantJobForm.isAdding"
          class="bg-teal-800 px-4 py-2 text-white"
          @click="submitInstantJobForm"
        >
          Get a call
        </button>
  ...
  meta: [
    {
      name: "description",
      content:
        "Find jobs & talents using native AI tools. Find the best jobs & growth opportunities. Best Job Portal in India. Get free personalized job recommendations.",
    },
    {
      name: "keywords",
      content:
        "job portal, india job portal, job apply application, job portal sites in india, application regarding job, Free Job Posting Portals in India",
    },
    { name: "author", content: "Visko HR Private Limited" },
  ],
});
