      ...
      <div v-if="activeMenu == 'profile'" class="profile">
        ...
        <div class="w-full bg-remark-light p-5 rounded-lg shadow-xl shadow-slate-100 border border-teal-100 ">
          ...
          <div>
            ...
            <div class="h-1"></div>
            <p class="text-slate-500">{{ userStore.user.user_bio }}</p>
          </div>
          <div class="h-8"></div>
          <div class="flex justify-between">
            <div class="w-6/12">
              <div>
                ...
                <div class="h-1"></div>
                <p class="text-slate-500">{{ userStore.user.user_email ?? "NA" }}</p>
              </div>
              <div class="h-8"></div>
              <div>
      ...
      <div v-if="activeMenu == 'saved-jobs'" class="saved-jobs" style="height: 35rem; overflow-y: scroll">
        <div class="w-full rounded-lg">
          <div class="px-3 py-3">
            ...
            <div class="h-5"></div>
            <div v-if="!savedJobs.isFetching" class="flex justify-between flex-wrap" >
      ...
      <div v-if="activeMenu == 'applied-jobs'" class="applied-jobs" style="height: 35rem; overflow-y: scroll">
        <div class="w-full rounded-lg">
          <div class="px-3 py-3">
            ...
            <div class="h-5"></div>
            <div v-if="!appliedJobs.isFetching" class="flex justify-between flex-wrap">
      ...
      <div v-if="activeMenu == 'ai-recommended-jobs'" class="ai-recommended-jobs" style="height: 38rem; overflow-y: scroll">
        <div class="w-full rounded-lg" >
          <div class="px-3 py-3">
            ...
            <div class="h-5"></div>
            <div v-if="!recommendedJobs.isFetching" class="flex justify-between flex-wrap">
